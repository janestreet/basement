...
module T = struct
  ...
  and 'a t = { inner : 'a inner Atomic.t } [@@unboxed]
...
module type S_nonportable_concrete = S_nonportable with type 'a t := 'a Nonportable.t
module type S_portable_concrete = S_portable with type 'a t := 'a Nonportable.t

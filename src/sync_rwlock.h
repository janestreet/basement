...
/* Reader-writer lock implementation mirroring OCaml stdlib mutexes. */
...
Caml_inline int sync_rwlock_rdlock(sync_rwlock m) { return pthread_rwlock_rdlock(m); }

Caml_inline int sync_rwlock_wrlock(sync_rwlock m) { return pthread_rwlock_wrlock(m); }

Caml_inline int sync_rwlock_unlock(sync_rwlock m) { return pthread_rwlock_unlock(m); }

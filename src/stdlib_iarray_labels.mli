...
val init : 'a. int -> f:(int -> 'a) -> 'a iarray
...
val append : 'a. 'a iarray -> 'a iarray -> 'a iarray

(** The locally-allocating version of [append]. *)
val append_local : 'a. 'a iarray -> 'a iarray -> 'a iarray

(** Same as {!append}, but concatenates a list of immutable arrays. *)
val concat : 'a. 'a iarray list -> 'a iarray

(** The locally-allocating version of [concat]. *)
val concat_local : 'a. 'a iarray list -> 'a iarray
...
val sub : 'a. 'a iarray -> pos:int -> len:int -> 'a iarray

(** The locally-allocating version of [sub]. *)
val sub_local : 'a. 'a iarray -> pos:int -> len:int -> 'a iarray

(** [to_list a] returns the list of all the elements of [a]. *)
val to_list : 'a. 'a iarray -> 'a list

(** The locally-allocating version of []. *)
val to_list_local : 'a. 'a iarray -> 'a list
...
val of_list : 'a. 'a list -> 'a iarray

(** The locally-allocating version of [of_list]. *)
val of_list_local : 'a. 'a list -> 'a iarray
...
val to_array : 'a. 'a iarray -> 'a array
...
val fold_left : 'a 'b. f:('a -> 'b -> 'a) -> init:'a -> 'b iarray -> 'a
...
val fold_left_local : 'a 'b. f:('a -> 'b -> 'a) -> init:'a -> 'b iarray -> 'a

(** The locally-constrained but globally-allocating version of [fold_left]. *)
val fold_left_local_input : 'a 'b. f:('a -> 'b -> 'a) -> init:'a -> 'b iarray -> 'a

(** The locally-allocating but global-input version of [fold_left].

    WARNING: This function consumes O(n) extra stack space, as every intermediate
    accumulator will be left on the local stack! *)
val fold_left_local_output : 'a 'b. f:('a -> 'b -> 'a) -> init:'a -> 'b iarray -> 'a
...
(** [fold_right ~f a ~init] computes [f a.:(0) (f a.:(1) ( ... (f a.:(n-1) init) ...))],
    where [n] is the length of the immutable array [a]. *)
val fold_right : 'a 'b. f:('b -> 'a -> 'a) -> 'b iarray -> init:'a -> 'a

(** The locally-constrained and locally-allocating version of [fold_right].

    WARNING: This function consumes O(n) extra stack space, as every intermediate
    accumulator will be left on the local stack! *)
val fold_right_local : 'a 'b. f:('b -> 'a -> 'a) -> 'b iarray -> init:'a -> 'a

(** The locally-constrained but globally-allocating version of [fold_right]. *)
val fold_right_local_input : 'a 'b. f:('b -> 'a -> 'a) -> 'b iarray -> init:'a -> 'a

(** The locally-allocating but global-input version of [fold_right].

    WARNING: This function consumes O(n) extra stack space, as every intermediate
    accumulator will be left on the local stack! *)
val fold_right_local_output : 'a 'b. f:('b -> 'a -> 'a) -> 'b iarray -> init:'a -> 'a
...
val iter2 : 'a 'b. f:('a -> 'b -> unit) -> 'a iarray -> 'b iarray -> unit

(** The locally-scoped version of [iter2]. *)
val iter2_local : 'a 'b. f:('a -> 'b -> unit) -> 'a iarray -> 'b iarray -> unit

(** The first-biased partly-locally-scoped version of [iter2]. *)
val iter2_local_first : 'a 'b. f:('a -> 'b -> unit) -> 'a iarray -> 'b iarray -> unit

(** The second-biased partly-locally-scoped version of [iter2]. *)
val iter2_local_second : 'a 'b. f:('a -> 'b -> unit) -> 'a iarray -> 'b iarray -> unit
...
(** [map2 ~f a b] applies function [f] to all the elements of [a] and [b], and builds an
    ...
    @raise Invalid_argument if the immutable arrays are not the same size. *)
val map2 : 'a 'b 'c. f:('a -> 'b -> 'c) -> 'a iarray -> 'b iarray -> 'c iarray

(** The locally-scoped and locally-allocating version of [map2]. *)
val map2_local : 'a 'b 'c. f:('a -> 'b -> 'c) -> 'a iarray -> 'b iarray -> 'c iarray
...
val for_all : 'a. f:('a -> bool) -> 'a iarray -> bool

(** The locally-scoped version of [for_all]. *)
val for_all_local : 'a. f:('a -> bool) -> 'a iarray -> bool
...
val exists : 'a. f:('a -> bool) -> 'a iarray -> bool

(** The locally-scoped version of [exists]. *)
val exists_local : 'a. f:('a -> bool) -> 'a iarray -> bool

(** Same as {!for_all}, but for a two-argument predicate.
    @raise Invalid_argument if the two immutable arrays have different lengths. *)
val for_all2 : 'a 'b. f:('a -> 'b -> bool) -> 'a iarray -> 'b iarray -> bool

(** The locally-scoped version of [for_all2]. *)
val for_all2_local : 'a 'b. f:('a -> 'b -> bool) -> 'a iarray -> 'b iarray -> bool

(** The first-biased partly-locally-scoped version of [for_all2]. *)
val for_all2_local_first : 'a 'b. f:('a -> 'b -> bool) -> 'a iarray -> 'b iarray -> bool

(** The second-biased partly-locally-scoped version of [for_all2]. *)
val for_all2_local_second : 'a 'b. f:('a -> 'b -> bool) -> 'a iarray -> 'b iarray -> bool

(** Same as {!exists}, but for a two-argument predicate.
    @raise Invalid_argument if the two immutable arrays have different lengths. *)
val exists2 : 'a 'b. f:('a -> 'b -> bool) -> 'a iarray -> 'b iarray -> bool

(** The locally-scoped version of [exists2]. *)
val exists2_local : 'a 'b. f:('a -> 'b -> bool) -> 'a iarray -> 'b iarray -> bool

(** The first-biased partly-locally-scoped version of [exists2]. *)
val exists2_local_first : 'a 'b. f:('a -> 'b -> bool) -> 'a iarray -> 'b iarray -> bool

(** The second-biased partly-locally-scoped version of [exists2]. *)
val exists2_local_second : 'a 'b. f:('a -> 'b -> bool) -> 'a iarray -> 'b iarray -> bool
...
val find_opt : 'a. f:('a -> bool) -> 'a iarray -> 'a option

(** The locally-constrained and locally-allocating version of []. *)
val find_opt_local : 'a. f:('a -> bool) -> 'a iarray -> 'a option
...
val find_map : 'a 'b. f:('a -> 'b option) -> 'a iarray -> 'b option

(** The locally-constrained and locally-allocating version of [find_map]. *)
val find_map_local : 'a 'b. f:('a -> 'b option) -> 'a iarray -> 'b option

(** The locally-constrained but globally-allocating version of [find_map]. *)
val find_map_local_input : 'a 'b. f:('a -> 'b option) -> 'a iarray -> 'b option

(** The locally-allocating but global-input version of [find_map]. *)
val find_map_local_output : 'a 'b. f:('a -> 'b option) -> 'a iarray -> 'b option

(** {1 Arrays of pairs} *)

(** [split [:(a1,b1); ...; (an,bn):]] is [([:a1; ...; an:], [:b1; ...; bn:])]. *)
val split : 'a 'b. ('a * 'b) iarray -> 'a iarray * 'b iarray

(** The locally-allocating version of [split]. *)
val split_local : 'a 'b. ('a * 'b) iarray -> 'a iarray * 'b iarray

(** [combine [:a1; ...; an:] [:b1; ...; bn:]] is [[:(a1,b1); ...; (an,bn):]]. Raise
    [Invalid_argument] if the two immutable iarrays have different lengths. *)
val combine : 'a 'b. 'a iarray -> 'b iarray -> ('a * 'b) iarray

(** The locally-allocating version of [combine]. *)
val combine_local : 'a 'b. 'a iarray -> 'b iarray -> ('a * 'b) iarray
...
val sort : 'a. cmp:('a -> 'a -> int) -> 'a iarray -> 'a iarray
...
val stable_sort : 'a. cmp:('a -> 'a -> int) -> 'a iarray -> 'a iarray

(** Same as {!sort} or {!stable_sort}, whichever is faster on typical input. *)
val fast_sort : 'a. cmp:('a -> 'a -> int) -> 'a iarray -> 'a iarray
